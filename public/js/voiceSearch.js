...
class VoiceWidget {
    ...
    `;
        ...
        var mic = document.getElementById("algolia-mic");
        var searchInput = document.getElementById("algolia-search-input");
        var wave = document.getElementById("bars");
    ...
    render(renderOptions) {
        ...
        if (renderOptions.results.userData) {
            var action = renderOptions.results.userData[0].action;
